    ...
    const faqs = [
        {
            ...
            items: [
                {
                    question: "How can I register for the Liutex Vortex Summit?",
        ...
        },
        {
            ...
            items: [
                {
                    question: "How can I submit an abstract on Liutex or Vortex research?",
                    answer: "Abstracts can be submitted via the 'Abstract Submission' page. We welcome research on Liutex mathematical theory, turbulence identification, and various applications in engineering and science."
                },
                {
                    question: "When will I be notified about my abstract acceptance?",
                    answer: "Notifications of acceptance will be sent via email within 2-3 weeks after the submission deadline, following review by our scientific committee."
                },
                {
                    question: "Can I present multiple papers on different vortex identification methods?",
                    answer: "Yes, you can submit multiple abstracts. However, please ensure that each abstract presents distinct research findings and contributes to the themes of the summit."
                },
                {
                    question: "What presentation formats are available (Oral/Poster)?",
                    answer: "Presentations can be in the form of oral presentations or poster displays. You can select your preference during submission, but the final decision rests with the Scientific Committee based on technical merit."
                }
            ]
        },
        {
            ...
            items: [
                {
                    ...
                    answer: "The congress will be held at the Grand Convention Center. Detailed venue information and maps are available on the 'Venue' page."
                },
                {
