                    ...
                    <div className="brochure-grid">
                        ...
                        <div className="brochure-details">
                            ...
                            <p className="mb-4 text-muted">
                                Download the official conference brochure to get comprehensive information about the Global Summit on Liutex Theory.
                            ...
                            <div className="brochure-actions">
                                <a href={brochurePdf} download="Liutex-Vortex-Summit-Brochure.pdf" className="download-btn">
                                    <Download size={20} />
                                    Download Brochure
                                </a>
