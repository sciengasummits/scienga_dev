                ...
                <div className="container">
                    <div className="visa-content-wrapper">
                        ...
                        <p className="visa-intro-text">
                            The <strong>Global Summit on Liutex Theory and Applications</strong> welcomes speakers & delegates from all over the world.
                        ...
                        <div className="visa-info-block">
                            ...
                            <ul className="visa-list">
                                <li>
                                    <strong>Check if you require a visa to enter Singapore</strong> using the Immigration & Checkpoints Authority (ICA) website or your local Singapore Consulate.
                                </li>
                                <li>
                                    Nationals of many countries (including <strong>USA, UK, Canada, Australia, Japan, and most EU countries</strong>) may enter Singapore for short-term visits (typically 30-90 days) without a visa.
                                </li>
                                <li>
                                    Nationals of other countries may require an <strong>Entry Visa</strong>. Please check the ICA website for the latest list of countries requiring a visa.
                                </li>
                            </ul>
                        </div>
