                            ...
                            <div className="form-row">
                                ...
                                <div className="form-group">
                                    ...
                                    >
                                        ...
                                        <option value="math_theory">Mathematical Theory of Liutex</option>
                                        <option value="vortex_id">Vortex Identification Methods</option>
                                        <option value="turbulence">Turbulence Structure Analysis</option>
                                        <option value="aerodynamics">Aerodynamics & Hydrodynamics</option>
                                        <option value="meteorology">Meteorological Vortex Dynamics</option>
                                        <option value="oceanography">Ocean Vortex Dynamics</option>
                                        <option value="bio_flow">Bio-medical Flow Analysis</option>
                                        <option value="cfd_liutex">CFD and Liutex Integration</option>
                                        <option value="ai_fluids">AI in Fluid Mechanics</option>
                                        <option value="comparison">Comparison of Vortex Criteria</option>
                                    </select>
                                </div>
                            </div>
