                ...
                <div className="modal-overlay" onClick={closeModal}>
                    <div className="modal-content" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="modal-body">
                            ...
                            <p className="modal-desc">{selectedSpeaker.bio || "A distinguished expert in the field of fluid dynamics and vortex theory, contributing significantly to research and academic literature."}</p>
                        </div>
                    </div>
                </div>
            )}
