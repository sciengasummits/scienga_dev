                        ...
                        <div className="premium-dates-list">
                            ...
                            <div className="premium-date-card">
                                <div className="pd-date-box">
                                    <span className="pd-month">TBA</span>
                                </div>
                                <div className="pd-content">
                                    <span className="pd-year">2026</span>
                                    <h4 className="pd-event">Abstract Submission Deadline</h4>
                                </div>
                            ...
                            <div className="premium-date-card">
                                ...
                                <div className="pd-content">
                                    <span className="pd-year">2026</span>
                                    <h4 className="pd-event">Early Bird Registration</h4>
                                </div>
                                <div className="pd-icon-bg">
                                    <CheckCircle size={40} />
                                </div>
                            ...
                            <div className="premium-date-card">
                                ...
                                <div className="pd-content">
                                    <span className="pd-year">2026</span>
                                    <h4 className="pd-event">Full Paper Submission</h4>
                                </div>
                                <div className="pd-icon-bg">
                                    <Clock size={40} />
                                </div>
