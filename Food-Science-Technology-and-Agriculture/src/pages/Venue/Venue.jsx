...
const Venue = () => {
    ...
    const nearbyAttractions = [
        ...
        },
        {
            name: 'Sentosa Island',
            distance: '5.4 km',
            image: 'https://images.unsplash.com/photo-1505881402582-c5bc11054f91?w=800&q=80'
        },
        {
                    ...
                    <div className="about-city-content">
                        <div className="about-city-text">
                            ...
                            <p className="city-description">
                                Singapore is a vibrant metropolis known for its rich cultural heritage,
                                world-class hospitality, and modern infrastructure. The city seamlessly blends
                                lush greenery with contemporary skyscrapers, offering visitors a unique experience.
                            </p>
                            <p className="city-description">
                                As one of Asia's premier conference destinations, Singapore provides excellent connectivity,
                                diverse accommodation options, and a wide range of dining and entertainment venues. The
                                city's tropical climate and safe environment make it an ideal location for international
                                summits.
                            </p>
