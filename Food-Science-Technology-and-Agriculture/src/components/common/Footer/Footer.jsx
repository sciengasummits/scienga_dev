        ...
        <footer className="footer">
            <div className="container">
                <div className="footer__top">
                    <div className="footer__col">
                        ...
                        <p className="footer__desc">
                            Global experts unite to shape the future of food systems.
                        ...
                        <ul className="footer__contact">
                            <li>
                                ...
                                <div>
                                    ...
                                    <span>Marina Bay Sands, Marina Bay, Singapore</span>
                                </div>
                            </li>
                ...
                <div className="footer__bottom">
                    <p>&copy; {new Date().getFullYear()} Global Summit on Food Science Technology and Agriculture. All Rights Reserved.</p>
                </div>
            </div>
        </footer>
    );
