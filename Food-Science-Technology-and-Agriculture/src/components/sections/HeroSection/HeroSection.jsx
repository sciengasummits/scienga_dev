            ...
            <div className="container hero__container">
                <div className="hero__content">
                    ...
                    <p className="hero__desc">
                        Global Summit on Food Science Technology and Agriculture, where global experts unite to shape
                        the future of food systems. Discover ground-breaking research, connect with
                        top professionals, and explore innovations transforming agriculture and food technology.
                    </p>
                ...
                <div className="hero__info-cards">
                    ...
                    <div className="info-card venue-card">
                        <h3>Venue</h3>
                        <p>Event Venue: Marina Bay Sands</p>
