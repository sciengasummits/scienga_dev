                        ...
                        <div className="premium-dates-list">
                            ...
                            <div className="premium-date-card highlight-card">
                                ...
                                <div className="pd-content">
                                    ...
                                    <span className="pd-sub">December 7-9, Singapore</span>
                                </div>
                                <div className="pd-icon-bg">
                                    <Star size={40} />
                                </div>
