...
import { Stethoscope, Activity, Heart, Globe } from 'lucide-react';
    ...
    return (
        <Link to={linkTo} className={`app-logo ${className}`} onClick={onClick}>
            ...
            <div className="logo-text-container">
                <span className="logo-text-top">World</span>
                <span className="logo-text-main">General Medicine</span>
                <span className="logo-text-sub">Congress</span>
            </div>
        </Link>
    );
};
