                    ...
                    <div className="brochure-grid">
                        <div className="brochure-preview">
                            <div className="preview-card">
                                ...
                                <div className="preview-badge">2025 Edition</div>
                            </div>
                        </div>
                        ...
                        <div className="brochure-details">
                            ...
                            <p className="mb-4 text-muted">
                                Download the official conference brochure to get comprehensive information about the World General Medicine Congress.
