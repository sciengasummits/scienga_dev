            ...
            <div className="container hero__container">
                <div className="hero__content">
                    ...
                    <p className="hero__desc">
                        Global Summit on Clean Energy and Sustainable Technologies, where global experts unite to shape
                        the future of sustainable energy. Discover ground-breaking clean technologies, connect with
                        top environmental professionals, and explore solutions transforming our planet's energy resilience.
                    </p>
