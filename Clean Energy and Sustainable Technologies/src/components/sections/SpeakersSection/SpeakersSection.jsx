                    ...
                    <div className="modal-overlay" onClick={closeModal}>
                        <div className="modal-content" onClick={e => e.stopPropagation()}>
                            ...
                            <div className="modal-body">
                                ...
                                <p className="modal-desc">{selectedSpeaker.bio || "A distinguished expert in the field of clean energy and sustainable technologies, contributing significantly to research and industrial applications. With years of experience leading sustainability initiatives and publishing groundbreaking studies, they have become a pivotal figure in advancing energy standards globally. Their work focuses on innovative clean technologies and strategies for a sustainable future."}</p>
                            </div>
                        </div>
                    </div>
                )
