                    ...
                    <div className="modal-overlay" onClick={closeModal}>
                        <div className="modal-content" onClick={e => e.stopPropagation()}>
                            ...
                            <div className="modal-body">
                                ...
                                <p className="modal-desc">{selectedSpeaker.bio || "A distinguished expert in the field of power energy and electrical engineering, contributing significantly to research and innovation. With years of experience leading engineering initiatives and publishing groundbreaking studies, they have become a pivotal figure in advancing sustainable energy standards globally. Their work focuses on innovative power systems and improving energy efficiency through advanced technology."}</p>
                            </div>
                        </div>
                    </div>
                )
