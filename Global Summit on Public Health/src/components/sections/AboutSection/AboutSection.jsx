            ...
            <div className="container about__container">
                ...
                <div className="about__content">
                    ...
                    <p className="about__text">
                        We are honored to welcome you to the <strong>Global Summit on Public Health and Preventive Medicine</strong>, scheduled for <strong>October 26–28, 2026</strong>, at the <strong>Congress Center Geneva, Switzerland</strong>. This premier international gathering brings together public health officials, medical researchers, and global health advocates to explore groundbreaking strategies in disease prevention and health promotion.
                    </p>
                    <p className="about__text">
