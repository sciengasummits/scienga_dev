...
const Navbar = () => {
    ...
    const isOnlineRegPage = location.pathname === '/online-registration';
    const navbarClasses = `navbar ${isScrolled || isOnlineRegPage ? 'navbar--scrolled' : ''}`;
    ...
    return (
        <nav className={navbarClasses}>
            <div className="container navbar__container">
                        ...
                        <div className="navbar__contact">
                            <div className="contact-item">
                                ...
                                <div className="contact-info">
                                    ...
                                    <span className="contact-value">contact@publichealthsummit.com</span>
                                </div>
                            </div>
                            <div className="contact-item">
                ...
                {isOnlineRegPage && (
                    <div className="navbar__top navbar__top--minimal">
                        <Logo onClick={closeMobileMenu} />
                        <button className="navbar__toggle" onClick={toggleMobileMenu}>
                            {isMobileMenuOpen ? <X size={24} /> : <Menu size={24} />}
                        </button>
                ...
                {!isOnlineRegPage && <div className="navbar__divider"></div>}
